import{_ as a,C as p,o as l,c as o,H as e,k as s,a as t,S as c}from"./chunks/framework.538c82e7.js";const g=JSON.parse('{"title":"嵌套路由","description":"","frontmatter":{},"headers":[],"relativePath":"zh/guide/essentials/nested-routes.md","filePath":"zh/guide/essentials/nested-routes.md"}'),r={name:"zh/guide/essentials/nested-routes.md"},y=s("h1",{id:"嵌套路由",tabindex:"-1"},[t("嵌套路由 "),s("a",{class:"header-anchor",href:"#嵌套路由","aria-label":'Permalink to "嵌套路由"'},"​")],-1),B=c(`<p>一些应用程序的 UI 由多层嵌套的组件组成。在这种情况下，URL 的片段通常对应于特定的嵌套组件结构，例如：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki one-dark-pro vp-code-dark"><code><span class="line"><span style="color:#abb2bf;">/user/johnny/profile                     /user/johnny/posts</span></span>
...
<span class="line"><span style="color:#24292E;">    children: [{ path: </span><span style="color:#032F62;">&#39;&#39;</span><span style="color:#24292E;">, name: </span><span style="color:#032F62;">&#39;user&#39;</span><span style="color:#24292E;">, component: UserHome }],</span></span>
<span class="line"><span style="color:#24292E;">  },</span></span>
<span class="line"><span style="color:#24292E;">]</span></span></code></pre></div>`,21);function i(d,F,A,E,u,C){const n=p("VueSchoolLink");return l(),o("div",null,[y,e(n,{href:"https://vueschool.io/lessons/nested-routes",title:"Learn about nested routes"}),B])}const v=a(r,[["render",i]]);export{g as __pageData,v as default};
