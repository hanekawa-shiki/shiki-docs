...
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div>`,10);function i(A,d,E,F,u,h){const n=p("VueSchoolLink");return l(),o("div",null,[y,e(n,{href:"https://vueschool.io/lessons/route-meta-fields",title:"Learn how to use route meta fields"}),B])}const D=a(r,[["render",i]]);export{m as __pageData,D as default};
