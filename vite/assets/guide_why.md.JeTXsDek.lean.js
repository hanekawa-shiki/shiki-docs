...
`,p=n("",10),d=n("",14),g=JSON.parse('{"title":"Why Vite","description":"","frontmatter":{},"headers":[],"relativePath":"guide/why.md","filePath":"guide/why.md"}'),h={name:"guide/why.md"},x=Object.assign(h,{setup(c){return(f,u)=>{const e=a("svg-image");return s(),r("div",null,[p,t(e,{svg:i(l)},null,8,["svg"]),t(e,{svg:i(o)},null,8,["svg"]),d])}}});export{g as __pageData,x as default};
